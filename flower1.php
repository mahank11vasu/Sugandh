    ...
    <div id="container2">
      ...
      <div id="con2box1">
        <div id="flexcon2box1">
          ...
          <div class="fhead">Seasons</div>
          <div>
            <input type="radio" name="filter" id="summer" class="fvalue" />Summer
          </div>
          <div>
            <input type="radio" name="filter" id="winter" class="fvalue" />Winter
          </div>
          <div>
            <input type="radio" name="filter" id="spring" class="fvalue" />Spring
          </div>
          <div>
            <input type="radio" name="filter" id="autumn" class="fvalue" />Autumn
          </div>
          <div class="fhead">Colors</div>
          <div>
            <input type="radio" name="filter" id="red" class="fvalue" />Red
          </div>
          <div>
            <input type="radio" name="filter" id="white" class="fvalue" />White
          </div>
          <div>
            <input type="radio" name="filter" id="pink" class="fvalue" />Pink
          </div>
          <div>
            <input type="radio" name="filter" id="yellow" class="fvalue" />Yellow
          </div>
        </div>
      </div>
      <div id="con2box2">
